...
- 일기: 오늘/과거에 실제로 경험한 일, 감정, 장소 방문 (어제, 그제, N일전, 아까 등 포함)
- 일정: 미래의 약속, 계획, 구체적 행동 예정
- 체중: 실제 체중/몸무게 숫자를 측정·기록하는 경우만 (예: "74kg 찍었어", "몸무게 재니 76이야")
  ❌ 제외: 체중 걱정만 언급, 헬스장/운동/다이어트 일반 언급, 운동을 했다는 일기 기록
- 이메일: 메일 확인 요청
